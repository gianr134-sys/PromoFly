    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ marginBottom: 26 }}>
          ...
          >
            Escolha origem, destino e data para encontrar oportunidades na hora.
          </p>
        </div>
        ...
        >
          ...
          <div style={{ marginTop: 14, color: "#d97706", fontWeight: 700 }}>
            ...
            {resultados.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <InfoCard label="Preço" value={formatarPreco(item.preco)} destaque />
